...
export const sampleSales: SaleOrder[] = [
  ...
  { tab: '5/2/26', orderId: 'gHI789def', orderNum: '1063000003', buyer: 'builderpro', modelNum: 'DWE575SB', productName: 'DEWALT 7-1/4 in. Lightweight Circular Saw', qty: 1, sold: 89, cost: 67.80, earn: 78.50, profit: 10.70, margin: 13.63, showDuration: '01h 15m', host: 'Jason' },
  { tab: '5/2/26', orderId: 'jKL012ghi', orderNum: '1063000004', buyer: 'diyguru', modelNum: '48-22-8485', productName: 'Milwaukee PACKOUT Wall and Floor Mount', qty: 2, sold: 44, cost: 22.38, earn: 38.76, profit: 16.38, margin: 42.26, showDuration: '01h 15m', host: 'Jason' },
  ...
  { tab: '4/12/26', orderId: 'sTU901pqr', orderNum: '1061000003', buyer: 'fixitfrank', modelNum: 'DW735X', productName: 'DEWALT 13 in. Two-Speed Thickness Planer', qty: 1, sold: 350, cost: 280.00, earn: 308.00, profit: 28.00, margin: 9.09, showDuration: '02h 30m', host: 'Jason' },
  { tab: '4/12/26', orderId: 'vWX234stu', orderNum: '1061000004', buyer: 'probuilder', modelNum: '48-59-1850', productName: 'Milwaukee M18 5.0 Ah Battery 2-Pack', qty: 1, sold: 129, cost: 98.00, earn: 113.52, profit: 15.52, margin: 13.67, showDuration: '02h 30m', host: 'Jason' },
  { tab: '4/5/26', orderId: 'yZA567vwx', orderNum: '1060000001', buyer: 'workshopking', modelNum: 'DCS361B', productName: 'DEWALT 20V MAX Cordless Miter Saw', qty: 1, sold: 225, cost: 180.00, earn: 198.00, profit: 18.00, margin: 9.09, showDuration: '01h 45m', host: 'Jason' },
  { tab: '4/5/26', orderId: 'bCD890yza', orderNum: '1060000002', buyer: 'contractorjoe', modelNum: '2852-20', productName: 'Milwaukee M18 1/2 in. Drill/Driver', qty: 1, sold: 69, cost: 52.25, earn: 60.72, profit: 8.47, margin: 13.94, showDuration: '01h 45m', host: 'Jason' },
];
