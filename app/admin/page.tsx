...
const SHIP_PERIODS: { label: string; value: ShipPeriod }[] = [
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        {SHIP_PERIODS.map(btn => (
          <button
            key={btn.value}
            onClick={() => setShipPeriod(btn.value)}
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm">
          ...
          {total === 0 ? (
            <p className="text-slate-400 text-sm leading-relaxed">
              ...
              Format: <span className="font-mono text-xs bg-slate-100 dark:bg-slate-700 px-1.5 py-0.5 rounded">TX</span>
            </p>
          ) : (
