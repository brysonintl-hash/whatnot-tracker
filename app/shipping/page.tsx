  ...
  return (
    <div>
      ...
      {isAdminOrManager && <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm p-4 mb-4">
        <h3 className="text-sm font-bold text-white mb-3">Add {SECTION_LABELS[type].slice(0, -1)}</h3>
        {isUsps ? (
            ...
            <>
              {loading ? (
                ...
                <>
                  ...
                  {!isAdminOrManager && (
                    <div className="mb-4">
                      <h2 className="text-sm font-bold text-white mb-1">My Assigned Shipments</h2>
