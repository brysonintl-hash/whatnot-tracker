        ...
        <div className="w-full max-w-7xl mx-auto px-6 lg:px-12 py-10 flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 max-w-lg">
            ...
            <h1 className="text-5xl xl:text-6xl font-black text-white leading-[1.08] mb-5">
              Join the team.<br />
              <span style={{ color: '#e01515' }}>Get started today.</span>
            </h1>
            <p className="text-white/45 text-lg leading-relaxed mb-12">
              Create your account and an admin will assign<br className="hidden sm:block" />
              your role so you can get to work.
            </p>

            <div className="flex flex-wrap gap-3">
              {[
                { icon: <svg className="w-5 h-5 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>, label: 'Role-based Access' },
                { icon: <svg className="w-5 h-5 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>, label: 'Secure Login' },
                { icon: <svg className="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>, label: 'Instant Setup' },
              ].map(f => (
          ...
          <div
            className="w-full max-w-[460px] rounded-2xl p-8 flex-shrink-0 relative transition-all duration-300"
            style={{
          ...
          >
            ...
            <h2 className="text-[1.75rem] font-black text-white mb-1.5">Create Account</h2>
            <p className="text-white/35 text-sm mb-7">Fill in your details to get started</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Confirm password */}
              <div>
                <label className="block text-[11px] font-bold text-white/40 uppercase tracking-widest mb-2">Confirm Password</label>
                <div className="relative">
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-white/25 pointer-events-none">
              ...
              <button type="submit" disabled={loading}
                ...
                <span className="relative z-10">
                  {loading
                    ? <span className="flex items-center justify-center gap-2"><svg className="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8H4z"/></svg>Creating account...</span>
                    : 'Create Account →'
                  }
                </span>
            ...
            <a href="/api/auth/google"
              className="w-full flex items-center justify-center gap-3 py-3 rounded-xl text-sm font-bold text-white/85 transition-all mb-5"
              style={inputBase}
            ...
            <p className="text-center text-sm text-white/35">
              ...
              <Link href="/login" className="font-bold transition-colors" style={{ color: '#e01515' }}>Sign In</Link>
            </p>
          </div>
        </div>
      </main>
