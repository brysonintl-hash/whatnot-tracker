...
function BookmarkletSection({ appUrl }: { appUrl: string }) {
  // Auto-scrolls page to load all products, then extracts accurate titles from DOM text
    ...
    <div className="bg-violet-50 dark:bg-violet-900/20 border border-violet-200 dark:border-violet-800 rounded-xl p-5 mb-6">
      ...
      <div className="space-y-3 mb-4">
        {[
          ...
          { n: 2, text: 'Open the seller\'s Whatnot shop in your browser (make sure you\'re on the Shop tab)' },
          { n: 3, text: 'Click the bookmark — it will auto-scroll the page to load ALL products (~30 sec), then open this page with results' },
        ].map(step => (
