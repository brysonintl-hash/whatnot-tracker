    ...
    <div className="flex h-screen bg-slate-50 dark:bg-slate-900 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 bg-slate-900 border-b border-slate-800 flex items-center justify-between px-6 flex-shrink-0 shadow-sm">
          <div>
            <h1 className="text-lg font-black text-white">Hot Deals</h1>
            <p className="text-xs text-slate-400">{today}</p>
          </div>
          <button
            onClick={openAdd}
            className="flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white font-bold px-4 py-2 rounded-lg text-sm transition-colors shadow-sm"
          >
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-4 max-w-2xl">
            These are the products shown in the "Hot Deals Ending Soon" section on the homepage. Add, edit, or remove them any time — changes go live immediately, no deploy needed.
          </p>
